...
export function proxy_continue_response():WasmResult{return 0;}
export function proxy_send_local_response(response_code:uint32_t , response_code_details_ptr:CharPtr,
                          response_code_details_size: size_t , body_ptr:CharPtr, body_size: size_t ,
                          additional_response_header_pairs_ptr:CharPtr,
                          additional_response_header_pairs_size: size_t , grpc_status:uint32_t ):WasmResult{return 0;}
export function proxy_clear_route_cache():WasmResult{return 0;}

// SharedData
// Returns: Ok, NotFound
export function proxy_get_shared_data(key_ptr:CharPtr, key_size: size_t ,value_ptr:CharPtrPtr,  value_size: SizeTPtr,cas:Uint32Ptr):WasmResult{return 0;}
//  If cas != 0 and cas != the current cas for 'key' return false, otherwise set the value and
//  return true.
// Returns: Ok, CasMismatch
export function proxy_set_shared_data(key_ptr:CharPtr, key_size: size_t ,value_ptr:CharPtr, value_size: size_t , cas:uint32_t ):WasmResult{return 0;}
...
export function proxy_register_shared_queue(queue_name_ptr:CharPtr,queue_name_size: size_t ,  token:Uint32Ptr):WasmResult{return 0;}
// Returns: Ok, NotFound
export function proxy_resolve_shared_queue(vm_id:CharPtr, vm_id_size: size_t ,queue_name_ptr:CharPtr, queue_name_size: size_t ,token:Uint32Ptr):WasmResult{return 0;}
// Returns Ok, Empty, NotFound (token not registered).
export function proxy_dequeue_shared_queue(token:uint32_t , data_ptr:CharPtrPtr,data_size: SizeTPtr):WasmResult{return 0;}
// Returns false if the queue was not found and the data was not enqueued.
export function proxy_enqueue_shared_queue(token:uint32_t , data_ptr:CharPtr,data_size: size_t ):WasmResult{return 0;}

// Headers/Trailers/Metadata Maps
export function proxy_add_header_map_value(typ: HeaderMapType, key_ptr:CharPtr,key_size: size_t , value_ptr:CharPtr,value_size: size_t ):WasmResult{return 0;}
export function proxy_get_header_map_value(typ: HeaderMapType, key_ptr:CharPtr,key_size: size_t , value_ptr:CharPtrPtr,value_size: SizeTPtr):WasmResult{return 0;}
export function proxy_get_header_map_pairs(typ: HeaderMapType, ptr:CharPtrPtr,size: SizeTPtr):WasmResult{return 0;}
export function proxy_set_header_map_pairs(typ: HeaderMapType, ptr:CharPtr, size: size_t ):WasmResult{return 0;}
export function proxy_replace_header_map_value(typ: HeaderMapType, key_ptr:CharPtr,key_size: size_t , value_ptr:CharPtr,value_size: size_t ):WasmResult{return 0;}
export function proxy_remove_header_map_value(typ: HeaderMapType, key_ptr:CharPtr,key_size: size_t ):WasmResult{return 0;}
export function proxy_get_header_map_size(typ: HeaderMapType,  size: SizeTPtr):WasmResult{return 0;}

// Buffer
export function proxy_get_buffer_bytes(typ:BufferType, start:uint32_t , length:uint32_t ,ptr:CharPtrPtr,  size: SizeTPtr):WasmResult{return 0;}
export function proxy_get_buffer_status(typ:BufferType,  length_ptr: SizeTPtr,flags_ptr:Uint32Ptr):WasmResult{return 0;}

// HTTP
export function proxy_http_call(uri_ptr:CharPtr, uri_size: size_t , header_pairs_ptr:VoidPtr,header_pairs_size: size_t , body_ptr:CharPtr,body_size: size_t ,  trailer_pairs_ptr : VoidPtr,trailer_pairs_size: size_t , timeout_milliseconds:uint32_t ,token_ptr:Uint32Ptr):WasmResult{return 0;}
// gRPC
export function proxy_grpc_call(service_ptr:CharPtr, service_size: size_t ,service_name_ptr:CharPtr, service_name_size: size_t ,method_name_ptr:CharPtr, method_name_size: size_t ,request_ptr:CharPtr, request_size: size_t ,timeout_milliseconds:uint32_t ,  token_ptr:Uint32Ptr):WasmResult{return 0;}
export function proxy_grpc_stream(service_ptr:CharPtr, service_size: size_t ,service_name_ptr:CharPtr, service_name_size: size_t ,method_name_ptr:CharPtr, method_name_size: size_t ,token_ptr:Uint32Ptr):WasmResult{return 0;}
export function proxy_grpc_cancel(token:uint32_t ):WasmResult{return 0;}
export function proxy_grpc_close(token:uint32_t ):WasmResult{return 0;}
export function proxy_grpc_send(token:uint32_t , message_ptr:CharPtr, message_size: size_t ,end_stream:uint32_t ):WasmResult{return 0;}

// Metrics
export function proxy_define_metric(type:MetricType, name_ptr:CharPtr, name_size: size_t ,metric_id:Uint32Ptr):WasmResult{return 0;}
export function proxy_increment_metric(metric_id:uint32_t , offset : i64):WasmResult{return 0;}
export function proxy_record_metric(metric_id:uint32_t , value : u64):WasmResult{return 0;}
export function proxy_get_metric(metric_id:uint32_t ,  result:Uint64Ptr):WasmResult{return 0;}

// System
export function proxy_set_effective_context(effective_context_id:uint32_t ):WasmResult{return 0;}
export function proxy_done():WasmResult{return 0;}
